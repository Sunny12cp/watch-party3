...
function Controls({ state, setState, togglePlayback, videoPlayerRef, room }: any) {
    ...
    const onSeekMouseUpHandler = () => {
        ...
        socket?.emit("seek video", state.played, room);
    };
    ...
    return (
        <div
            className="absolute z-10 bottom-0 w-full controls py-5 rounded-b-lg transition-opacity duration-500"
